...
All notable features and major releases of the NQA Progressive Web App (PWA) audio player are documented below.

## [v3.72] - 2026-06-04
### Added
- **Integrated Changelog in Settings**: View all app features and version history directly in the application settings page.
- **Improved Full Player Flow**: Enhanced player layout positioning and scroll padding to ensure that when the full player loads, it resides perfectly at the very end of the page without obstructing any elements.

---

## Complete Features Directory (Top 100 Features)

### Playback & Core Audio Engine
...
### Settings, Configuration & Localization
